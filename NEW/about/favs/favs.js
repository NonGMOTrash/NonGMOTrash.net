...
function switchThought(thoughtId)
{
	for (var i = 0; i < thoughts.children.length; i++)
	{
		if (thoughts.children[i].id == thoughtId)
		{
			thoughts.children[i].style.display = "block";
		}
		else
		{
			thoughts.children[i].style.display = "none";
		}
	}
